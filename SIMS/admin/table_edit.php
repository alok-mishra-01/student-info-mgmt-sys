...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"><head>
	...
	<body>
		<div id="main">
			...
			<div id="menu">
				<ul>
					...
					<li><a href="att_edit.php">Attendance</a></li>
                                        <li class="selected"><a href="table_edit.php">Time-Table</a></li>
			...
			<div id="content">
				<div class="article">
					<h2>Time-Table Changes</h2>
<br>
<h3>Please Select the branch and semester to continue:</h3><p>
...
<br><p>
<h3>Enter the section name:</h3><input type="text" size="2" name="sections"><p>
<br>
<tr>
