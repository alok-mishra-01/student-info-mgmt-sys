<?php
//This file just selects the subject for which marks are viewed.  
include "session.php";
...
<html>
	...
	<body>
<form name="myform1" action="acad_display.php" method="POST">
		<div class="conteneur">	
			<div class="header">
		  ...
		  <div class="centre">
		    <p>&nbsp;</p>
<?php
echo "<font size='4'>Select the subject for which you want to view marks:</font><br><br>";require "check.php";
...
foreach ($row1 as $c)
{
  ...
  echo '<input type="radio" name="subj5" value="'.$c['sub_code'].'"> ';
  echo $c['sub_name'];
  echo "</h1><br>";
}
?>
